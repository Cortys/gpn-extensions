...
from gpn.nn import entropy_reg, categorical_entropy_reg, expected_categorical_entropy
...
class GPN_MLP(GPN):
    ...
    def loss(self, prediction, data):
        ...
        return {
            "UCE": uce,
            "REG": reg,
            **self.CE_loss(prediction, data, reduction="sum"),
        }
